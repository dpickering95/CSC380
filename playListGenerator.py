...
f.write('\t\t\t\tself.songNum = np.argmax(temp)\n')
f.write('\n')
f.write('\tdef avDiff(self):\n')
f.write('\t\t## avDiff is the same for all rows\n')
f.write('\t\trow = 0\n')
f.write('\t\ttot = 0\n')
f.write('\n')
f.write('\t\tfor i in range(len(self.prob_matrix[row])):\n')
